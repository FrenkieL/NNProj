...
\begin{inparaenum}\item Krutost linearnog kernela: jedan piksel može više utjecati na vrijednost \item RBF se bolje ponaša kod linearno neodvojivih problema, što ovo jest. \item dodatni hiperparametar kod RBF kernela ($\gamma$) \end{inparaenum}.
