...
\begin{inparaenum}\item Krutost linearnog kernela \item dodatni hiperparametar kod RBF kernela ($\gamma$) \end{inparaenum}.
...
slične veličine. Naša mreža, napose SVM za RBF kernelom ima nešto bolji rezultat. To je vjerojatno zbog poboljšane mogućnosti klasifikacije
...
\begin{tabular}{|p{50pt}|p{50pt}|p{30pt}|p{25pt}|p{25pt}|p{25pt}|}
	...
	\hline
	CvT \ref{} & ArtiFact & 98.54\% & 0.99 & 0.98 & 0.98\\ \hline
	CNN \ref{} & Kaggle ai-get-img, CIFAKE, pygoogle & 93.9\% & 0.97 & 0.91 & 0.94\\ \hline
	ViT \ref{} & CIFAKE & 98.25\% & 0.99 & 0.98 & 0.98\\ \hline
\end{tabular}
\ \\
Međutim naši rezultati su znatno lošiji od novijih modela kao što su ViT transformatori ili modeli bazirani na njima (CvT). Transformatori bolje zadržavaju podatke nakon dugih sekvenci, odnosno između udaljenih piksela na istoj slici. Globalni uzorci se bolje raspoznavaju nego kod konvolucijskih mreža, bez gubitka kvalitete prepoznavanja lokalnih uzoraka \ref{}.
